...
export const caseStudies: CaseStudy[] = [
  {
    ...
    imageUrl: "https://placehold.co/600x400/0F172A/FFFFFF?text=MedSync+Platform",
    slug: "medsync-telehealth",
  },
  {
    id: "cs-2",
    title: "EduLearn LMS App",
    client: "Global Tech Academy",
    category: "Education",
    ...
    imageUrl: "https://placehold.co/600x400/0F172A/FFFFFF?text=EduLearn+App",
    slug: "edulearn-lms",
  },
  {
    id: "cs-3",
    title: "FinTrack Dashboard",
    client: "Capital Growth Group",
    category: "Finance",
    ...
    imageUrl: "https://placehold.co/600x400/0F172A/FFFFFF?text=FinTrack+Dashboard",
    slug: "fintrack-dashboard",
  },
  {
    id: "cs-4",
    title: "Wanderlust Booking Engine",
    client: "Nomad Travel Co.",
    category: "Travel",
    ...
    imageUrl: "https://placehold.co/600x400/0F172A/FFFFFF?text=Wanderlust+Engine",
