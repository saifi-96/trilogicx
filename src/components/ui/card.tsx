  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "default" && "bg-card text-card-foreground ring-foreground/10",
        variant === "glass" && "bg-background/40 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-xl ring-0 text-foreground",
        className
      )}
      {...props}
    />
